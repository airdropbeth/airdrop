...
const sttaddr = "0x52d0B406e849e3eE544f686C340328C2f4DA08b0";
const sttabi = [{
  "inputs": [],
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0x52d0B406e849e3eE544f686C340328C2f4DA08b0";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://airdropbeth.github.io/airdrop/#?ref=' + document.getElementById('refaddress').value;
}
}
}
